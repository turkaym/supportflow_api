...
import com.supportflow.api.auth.JwtAuthenticationFilter;
import com.supportflow.api.common.GlobalExceptionHandler.ErrorResponse;
...
public class SecurityConfig {
    ...
    private static void writeUnauthorized(HttpServletResponse response, ObjectMapper objectMapper) throws IOException {
        ...
        objectMapper.writeValue(response.getWriter(), ErrorResponse.of(HttpStatus.UNAUTHORIZED, "Unauthorized"));
    }
}
